...
/**
 * ---- Credentials ---- or ids get from the google calendarAPI - are those values required to get access to your calendar. If you see “process.env” this means
...
const credentials = {
  ...
  redirect_uris: ["https://kempke28.github.io/meat_app/"],
  javascript_origins: ["https://kempke28.github.io", "http://localhost:3000"],
};
 ...
 * Google and be authorized to see your calendar --- which is get from getAuthURL --- . After logging in, they’ll receive a code
 * as a URL parameter.
 *
 */
